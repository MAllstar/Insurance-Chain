...
var postHTML = 
  ...
  '<script>$(document).ready(function(){$.ajax({url:"http://localhost:3007/",type: "POST",data: {attr: "applicant", dat: "2017"},success:function(result){console.log(result)}});});</script>' +
  '<script>$(document).ready(function(){$("button").click(function(){$.ajax({url:"http://localhost:3007/",type: "POST",data: {attr: "applicant", dat: "2017"},success:function(result){console.log(result)}});});});</script>'  +
  '</body></html>';
